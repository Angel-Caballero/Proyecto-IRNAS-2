...
INSERTAR_RECURSOS('Ácido clorhídrico','HCl',10,1.0,3,'Reactivo','Cámara Frigorífica A');
INSERTAR_RECURSOS('Ácido sulfúrico','H2SO4',6,1.5,2,'Reactivo','Sótano');
INSERTAR_RECURSOS('Ácido nítrico','HNO3',4,3.0,1,'Reactivo','Cámara Frigorífica A');
INSERTAR_RECURSOS('Hidróxido de magnesio','Mg(OH)2',7,2.0,2,'Reactivo','Sótano');
...
INSERTAR_RECURSOS('Material 1',NULL,NULL,NULL,NULL,'Biológico','Invernadero');
INSERTAR_RECURSOS('Material 2',NULL,NULL,NULL,NULL,'Biológico','Sótano');
INSERTAR_RECURSOS('Material 3',NULL,NULL,NULL,NULL,'Biológico','Invernadero');
INSERTAR_RECURSOS('Material 4',NULL,NULL,NULL,NULL,'Biológico','Cámara in-vitro');
INSERTAR_RECURSOS('Material 5',NULL,NULL,NULL,NULL,'Biológico','Cámara in-vitro');
